...
**[1.5](https://blog.rust-lang.org/2015/12/10/Rust-1.5.html) — Cargo Install:** добавление возможности собрирать
...
> разработку микроконтроллеров с помощью Rust легкой, безопасной и в то же время 
> увлекательной.
> 
...
статистикой о том, насколько вырос Rust.
 ...
 - Когда Rust версии 1.0 был выпущен, можно было подсчитать количество компаний, 
    ...
    Rust в своих проектах для надежности и производительности.
