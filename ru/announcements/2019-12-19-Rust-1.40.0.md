...
Основными моментами обновления Rust 1.40.0 являются введение атрибута `#[non_exhaustive]` и улучшения `macros!()` и `#[attribute]`. Наконец, миграционные предупреждения анализатора заимствований стали серьёзными ошибками в Rust 2015. Смотрите [подробности релиза](https://github.com/rust-lang/rust/blob/master/RELEASES.md#version-1400-2019-12-19) для дополнительной информации.
