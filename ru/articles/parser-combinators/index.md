...
Во втором, мы подаем строку `"Hello Joe! Hello Robert!"` и видим, что он действительно использует строку `"Hello Joe!"` и возвращает остаток от ввода: `" Hello Robert!"` (ведущий пробел и всё остальное).
