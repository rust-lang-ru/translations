...
Давайте попробуем удалить комментарий с `element_start` и тесты, которые мы закомментировали ранее, и посмотрим, улучшится ли ситуация. Верните этот код в игру и попробуйте запустить тесты ...
